...
class _SearchState extends State<Search> {
  ...
  String formatDateTime(String dateTime) {
    ...
    final dayName = DateFormat.E().format(parsedDateTime);
    final abbreviatedDay = dayName.substring(0, 3);
    final formattedDate = DateFormat.MMMd().format(parsedDateTime);
    final time = DateFormat.jm().format(parsedDateTime);
